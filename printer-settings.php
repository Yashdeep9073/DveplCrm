...
<head>
	...
	<title>Printer Settings - D.V. Electromatic Pvt. Ltd</title>
												...
												<ul>
													...
													<li class="submenu">
														...
														<ul>
															...
															<li><a href="printer-settings.php" class="active">Printer
																</a></li>
								...
								<div class="page-header justify-content-end">
									...
									<div class="page-btn">
										<a href="#" class="btn btn-added" data-bs-toggle="modal"
											data-bs-target="#add-printer"><i data-feather="plus-circle"
												class="me-2"></i>Add New Printer</a>
									</div>
								</div>
								<div class="row">
									<div class="col-lg-12">
