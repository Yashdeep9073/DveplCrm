	...
	<div class="main-wrapper">
					...
					<ul>
						...
						<li class="submenu-open">
							...
							<ul>
								...
								<li><a href="sales-returns.php"><i data-feather="copy"></i><span>Sales Return</span></a>
								</li>
							...
							<ul>
								...
								<li class="submenu">
									<a href="javascript:void(0);" class="active subdrop"><i
											...
											class="menu-arrow"></span></a>
									<ul>
										<li><a href="attendance-employee.php" class="active">Employee</a></li>
						...
						<li class="submenu-open">
							...
							<ul>
								...
								<li><a href="income-report.php"><i data-feather="bar-chart"></i><span>Income
											Report</span></a></li>
								<li><a href="tax-reports.php"><i data-feather="database"></i><span>Tax Report</span></a>
								</li>
				...
				<div id="sidebar-menu-2" class="sidebar-menu sidebar-menu-three">
					<aside id="aside" class="ui-aside">
						<ul class="tab nav nav-tabs" id="myTab" role="tablist">
							...
							<li class="nav-item" role="presentation">
								<a class="tablinks nav-link active" href="#set2" id="set-tab2" data-bs-toggle="tab"
					...
					<div class="tab-content tab-content-four pt-2">
						...
						<ul class="tab-pane active" id="employee" aria-labelledby="set-tab2">
							...
							<li class="submenu">
								<a href="javascript:void(0);" class="active subdrop"><span>Attendence</span><span
										class="menu-arrow"></span></a>
								<ul>
									<li><a href="attendance-employee.php" class="active">Employee Attendence</a></li>
		...
		<div class="sidebar horizontal-sidebar">
			<div id="sidebar-menu-3" class="sidebar-menu">
				<ul class="nav">
					<li class="submenu">
						<a href="dashboard.php"><i data-feather="grid"></i><span> Main Menu</span> <span
								class="menu-arrow"></span></a>
						<ul>
							<li class="submenu">
								<a href="javascript:void(0);"><span>Dashboard</span> <span
