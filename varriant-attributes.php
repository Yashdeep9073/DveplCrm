						...
						<ul>
							...
							<li class="submenu-open">
								...
								<ul>
									...
									<li class="active"><a href="varriant-attributes.php"><i data-feather="layers"></i><span>Variant Attributes</span></a></li>
					...
					<div id="sidebar-menu-2" class="sidebar-menu sidebar-menu-three">
						...
						<div class="tab-content tab-content-four pt-2">
							...
							<ul class="tab-pane active" id="product" aria-labelledby="messages-tab">
								...
								<li><a href="varriant-attributes.php" class="active"><span>Variant Attributes</span></a></li>
