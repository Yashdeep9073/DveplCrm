...
$query_jobs = "
    ...
    WHERE  user_job_request.concerned_engineer = ? 
       OR user_job_request.costing_engineer = ? 
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="user-work-edit.php?job_id=<?php echo base64_encode($data_jobs['job_id']); ?>" class="btn btn-success">UPDATE</a>
                                                    <!-- <a href="user-work-edit.php?job_id=<?php echo $data_jobs['job_id']; ?>" onclick="return confirm('Are you sure want to delete?')" class="btn btn-danger rounded-sm">DELETE</a> -->
                                                </td>
                                            </tr>
                                        <?php
                                            $i++;
