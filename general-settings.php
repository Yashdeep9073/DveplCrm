...
if (isset($_POST['submit'])) {
	...
	$query11 = "UPDATE `tbl_admin` SET Username ='$username', email ='$email', mobile='$mobile',uploaded_file='$unique_filename' WHERE _id ='" . $_SESSION['admin_id'] . "'";
	$result = mysqli_query($conn, $query11);
	if ($result) {
		$_SESSION['status'] = "Your changes to Profile setting information have been Updated successfully";
...
<head>
	...
	<title>General Settings - D.V. Electromatic Pvt. Ltd</title>
											...
											<div class="mb-0">
												<div>
													<div class="col-lg-4 col-12 form-group">
														<!-- <label>Image <span style="color:red;">(120 * 150)</span></label> -->
														<input name="uploaded_file" type="file"
															class="form-control input-md" accept="image/*">
														<input type="hidden" name="old_image"
															value="<?php echo $data_general['uploaded_file']; ?>">
													</div>
													<div class="col-xl-3 col-lg-6 col-12 form-group">
														<img id="blah"
															src="<?php echo "user_image/". $data_general['uploaded_file']; ?>"
															alt="user_image"
												...
												<!-- </div> -->
												<span>For better preview recommended size is (120 * 150) Max size
													2MB.</span>
											</div>
										</div>
									</div>
										...
										<div class="col-md-4">
											<div class="mb-3">
												...
												<input type="text" class="form-control" name="Username"
													value="<?php echo $data_general['Username']; ?>">
											</div>
										</div>
										<div class="col-md-4">
											<div class="mb-3">
												...
												<input type="text" class="form-control" name="mobile"
													value="<?php echo $data_general['mobile']; ?>">
											</div>
										</div>
										<div class="col-md-4">
											<div class="mb-3">
												...
												<input type="email" class="form-control" name="email"
													value="<?php echo $data_general['email']; ?>">
											</div>
										</div>
									</div>
									<!-- <div class="card-title-head">
