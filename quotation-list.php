						...
						<ul>
							...
							<li class="submenu-open">
								...
								<ul>
									...
									<li class="active"><a href="quotation-list.php"><i data-feather="save"></i><span>Quotation</span></a></li>								
					...
					<div id="sidebar-menu-2" class="sidebar-menu sidebar-menu-three">
						...
						<div class="tab-content tab-content-four pt-2">
							...
							<ul class="tab-pane active" id="sales" aria-labelledby="profile-tab">
								...
								<li><a href="quotation-list.php" class="active"><span>Quotation</span></a></li>								
