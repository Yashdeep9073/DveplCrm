...
<head>
    ...
    <title>Brand Managment-D.V. Electromatic Pvt. Ltd</title>
                        ...
                        <div class="table-responsive">
                            <table class=" display " id="example" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    $i = 1;
                                    foreach ($result_brand as $data_brand) {
                                        ?>
                                        <tr>
                                            <!-- <td>
                                            <label class="checkboxs">
                                            ...
                                            <td>
                                                <?php echo $data_brand['brand_name']; ?>
                                            </td>
                                            <td>
                                                <?php echo $data_brand['status']; ?>
                                            </td>

                                            <td class="action-table-data">
                                                <div class="edit-delete-action">
                                                    <a href="edit-brand.php?id=<?php echo base64_encode($data_brand['brand_id']); ?>"
                                                        class="btn btn-success">UPDATE</a>

                                                    &nbsp;

                                                    <a href="delete-brand.php?id=<?php echo base64_encode($data_brand['brand_id']); ?>"
