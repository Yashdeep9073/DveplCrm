...
// Fetch logo and backpanel image from tbl_setting
$stmt = $conn->prepare('SELECT uploaded_file,favicon, backpanel_image FROM tbl_setting WHERE logo_id = 1'); // Adjust logo_id as needed
$stmt->execute();
...
$favicon = $favicon ?: 'assets/img/authentication/login02.png';

if (isset($_SESSION['user_name']) && isset($_SESSION['admin_id'])) {
	$name = $_SESSION['user_name'];
	$q = "SELECT * FROM  `tbl_admin` where _id ='" . $_SESSION['admin_id'] . "'";
	$upload_directory = "user_image/";
...
<div class="header-left active">
	<a href="dashboard.php" class="logo logo-normal">
		<img src="logo/<?php echo htmlspecialchars($logo_image); ?>" style="width: 100%;" alt="">
	</a>
	
	<a href="dashboard.php" class="logo-small">
		<img src="favicon/<?php echo htmlspecialchars($favicon); ?>" alt="">
	</a>
...
<ul class="nav user-menu">
		...
		<div class="top-nav-search">
			...
			<form action="#" class="dropdown">
				<div class="searchinputs dropdown-toggle" id="dropdownMenuClickable" data-bs-toggle="dropdown"
					...
					<h4>Welcome to Dvepl Jobs Control System </h4>
	...
	<li class="nav-item dropdown has-arrow main-drop">
		<a href="javascript:void(0);" class="dropdown-toggle nav-link userset" data-bs-toggle="dropdown">
			<span class="user-info">
				<span class="user-letter">
					<img src="user_image/<?php echo $data['uploaded_file']; ?>" alt="profile"
						style="width:40px; height:40px;" class="img-fluid">
				</span>
				<span class="user-detail">
					<span class="user-name"><?php if (isset($name)) {
												echo $name;
											} ?></span>
		...
		<div class="dropdown-menu menu-drop-user">
			<div class="profilename">
				<div class="profileset">
					<span class="user-img"><img src="user_image/<?php echo $data['uploaded_file']; ?>" alt="profile"
							style="width:40px; height:40px;" class="img-fluid">
						<span class="status online"></span></span>
					<div class="profilesets">
						<h6><?php if (isset($name)) {
								echo $name;
							} ?></h6>
						<!-- 								<h5>Super Admin</h5> -->
					</div>
