...
<html lang="en">
    <head>
        ...
        <title>Login - D.V. Electromatic Pvt. Ltd</title>
                        ...
                        <form action="register-process.php" method="post">
                            <div class="login-userset">
                               ...
                               <div class="form-login">
                                   ...
                                   <div class="pass-group">
                                       <input type="password" name="password" class="pass-inputs">
                               ...
                               <div class="signinform">
                                   <h4>Already have an account ? <a href="index.php" class="hover-a">Sign In Instead</a></h4>
                               </div>
                               ...
                               <div class="my-4 d-flex justify-content-center align-items-center copyright-text">
                                   <p>Copyright &copy; 2024 Vibrantick Infotech Solutions. All rights reserved</p>
                               </div>
                           </div>
                        </form>
