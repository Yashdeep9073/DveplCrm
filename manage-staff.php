...
$query_staff = "SELECT * FROM tbl_admin";
...
<head>
	...
	<title>Staff Management-D.V. Electromatic Pvt. Ltd</title>
						...
						<div class="table-responsive">
                             ...
                             if(isset($_SESSION['status_msg']))
                            {
								...
								<tbody>
									<?php
									$i = 1;
									foreach ($result_staff as $data_staff) {
										?>
										<tr>
											<!-- <td>
											<label class="checkboxs">
											...
											<td>
												<?php echo $data_staff['Username']; ?>
											</td>
											<td>
												<?php echo $data_staff['email']; ?>
											</td>
											<td>
												<?php echo $data_staff['password']; ?>
											</td>
											<td>
												<?php echo $data_staff['mobile']; ?>
											</td>
											<td>
												<?php echo $data_staff['status']; ?>
											</td>

											<td class="action-table-data">
												<div class="edit-delete-action">
													<a href="edit-user.php?id=<?php echo base64_encode($data_staff['_id']); ?>"
														class="btn btn-success">UPDATE</a>

													&nbsp;

													<a href="delete-admin.php?id=<?php echo base64_encode($data_staff['_id']); ?>"
									...
									<div class="col-lg-12">
										<div class="new-employee-field">
											...
											<div class="profile-pic-upload edit-pic">
												<div class="profile-pic">
													<span><img src="assets/img/users/edit-user.jpg" class="user-editer"
															alt="User"></span>
													<div class="close-img">
