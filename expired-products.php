						...
						<ul>
							...
							<li class="submenu-open">
								...
								<ul>
									...
									<li class="active"><a href="expired-products.php"><i data-feather="codesandbox"></i><span>Expired Products</span></a></li>
					...
					<div id="sidebar-menu-2" class="sidebar-menu sidebar-menu-three">
						...
						<div class="tab-content tab-content-four pt-2">
							...
							<ul class="tab-pane active" id="product" aria-labelledby="messages-tab">
								...
								<li><a href="expired-products.php" class="active"><span>Expired Products</span></a></li>
