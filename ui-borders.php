					...
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="submenu-open">
								...
								<ul>
									<li><a href="productlist.php"><i data-feather="box"></i><span>Products</span></a></li>
							...
							<li class="submenu-open">
								...
								<ul>
									...
									<li>
										<a href="components.php" ><i data-feather="pen-tool"></i><span>Components</span> </a>
									</li>
									<li>
								...
								<ul>
									<li class="submenu">
										...
										<ul>
											...
											<li><a href="ui-borders.php" class="active">Border</a></li>
					...
					<div id="sidebar-menu-2" class="sidebar-menu sidebar-menu-three">
						...
						<div class="tab-content tab-content-four pt-2">
							...
							<ul class="tab-pane" id="product" aria-labelledby="messages-tab">
								<li><a href="productlist.php"><span>Products</span></a></li>
