...
<head>
    ...
    <title>Testing Managment-D.V. Electromatic Pvt. Ltd</title>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($result_test as $data_test) {
                                            ...
                                            <label class="checkboxs">
                                                ...
                                                <!-- <td>
                                                    <?php echo $data_test['serial_no']; ?>
                                                </td> -->
                                                <td>
                                                    <?php echo $data_test['devel_code']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $data_test['j_id']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $data_test['ca_no']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $data_test['job_name']; ?>
                                                </td>

                                                <td>
                                                    <?php echo $data_test['concerned_engineer']; ?>
                                                </td>

                                                <td><?php echo $data_test['costing_engineer']; ?></td>
                                                <!-- <td><?php echo $data_test['name']; ?></td>  -->
                                                <!-- <td>
                                                    <?php echo $data_test['name1']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $data_test['email']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $data_test['phone_no']; ?>
                                                </td> -->
                                                <!-- <td>
                                                    <?php echo $data_test['item_no']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $data_test['gst']; ?>
                                                </td> -->
                                                <!-- <td>
                                                    <?php echo $data_test['amount']; ?>
                                                </td> -->
                                                <!-- <td>
                                                    <?php echo $data_test['total_amount']; ?>
                                                </td> -->
                                                <!-- <td>
                                                    <?php echo $data_test['advance']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $data_test['balance']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $data_test['po_payment']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $data_test['po_no']; ?>
                                                </td> -->
                                                <!-- <td>
                                                <?php echo $data_test['dispatch']; ?>
                                            </td> -->

                                                <td>
                                                    <?php echo $data_test['created_date']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $data_test['remark']; ?>
                                                </td>

                                                <td class="">
                                                    <div class="">
                                                        <a href="testing-edit.php?job_id=<?php echo base64_encode($data_test['job_id']); ?>"
                                                            class="btn btn-success">UPDATE</a>
                                                        <!-- <a class="me-2 p-2" href="#" data-bs-toggle="modal"
                                                    data-bs-target="#edit-brand"> -->
                                                        <!-- </a> -->&nbsp;<br>
                                                        <a href="delete-testing.php?job_id=<?php echo $data_test['job_id']; ?>"
