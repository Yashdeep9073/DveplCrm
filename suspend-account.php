<?php
    ...
    $query_account = "SELECT * FROM `tbl_admin` WHERE status='0'";
...
<html lang="en">
    <head>
        ...
        <title>Suspend Management-D.V. Electromatic Pvt. Ltd</title>
			...
			<div class="page-wrapper">
				<div class="content">
					<div class="page-header">
						...
						<!-- <div class="page-btn">
							<a href="#" class="btn btn-added" data-bs-toggle="modal" data-bs-target="#add-units"><i data-feather="plus-circle" class="me-2"></i>Add Staff User</a>
						</div> -->
					</div>
                       ...
                       <div class="card-body">
                        ...
                        <div class="table-responsive"> 
                            ...
                            if ($st1 > 0) {
                                ...
                                <?php
                                $i = 1;
                                foreach ($result_account as $data_account) {
                                    ?>
                                    <tr>
                                        <!-- <td>
                                            <label class="checkboxs">
                                        ...
                                        <td><?php  echo $i; ?></td>
                                        <td><?php  echo $data_account['Username']; ?></td>
                                        <td><?php  echo $data_account['email']; ?></td>
                                        <td><?php  echo $data_account['password']; ?></td>
                                        <td><?php  echo $data_account['mobile']; ?></td>
                                        <td><?php  echo $data_account['status']; ?></td>
                                        
                                        <td class="action-table-data">
                                            <div class="edit-delete-action">
                                            	<a href="edit-user.php?id=<?php echo base64_encode($data_account['_id']); ?>" class="btn btn-success">UPDATE</a>
 											
 												&nbsp;
 												
                                            	<a href="delete-admin.php?id=<?php echo base64_encode($data_account['_id']); ?>" onclick="return confirm('Are you sure want to delete?')" class="btn btn-danger">DELETE</a>
                                            </div>
                                        </td>
                                    <?php
                                  $i++;
