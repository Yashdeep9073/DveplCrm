...
<title>Category Management-D.V. Electromatic Pvt. Ltd</title>
                        ...
                        <div class="table-responsive">
                             ...
                             if(isset($_SESSION['status_msg']))
                            {
                                ...
                                <tbody>
                                    ...
                                    $i = 1;
                                    foreach ($result_category as $data__category) {
                                        ?>
                                        <tr>
                                            <!-- <td>
                                            <label class="checkboxs">
                                            ...
                                            <td>
                                                <?php echo $data__category['category_name']; ?>
                                            </td>
                                            <td>
                                                <?php echo $data__category['status']; ?>
                                            </td>

                                            <td class="action-table-data">
                                                <div class="edit-delete-action">
                                                    <a href="edit-category.php?id=<?php echo base64_encode($data__category['category_id']); ?>"
                                                        class="btn btn-success">UPDATE</a>

                                                    &nbsp;

                                                    <a href="delete-category.php?id=<?php echo base64_encode($data__category['category_id']); ?>"
