...
if(isset($_GET['id'])) {
    ...
    if(mysqli_num_rows($result) > 0) {
        ...
        if(isset($_POST['update_category'])) {
            ...
            $updatedCategoryStatus = mysqli_real_escape_string($conn, $_POST['status']);
            
            // Update the category in the database
            $updateQuery = "UPDATE tbl_category SET category_name = '$updatedCategoryName',status='$updatedCategoryStatus' WHERE category_id = $categoryId";
	  ...
	  header("location:manage-category.php?status_msg=$re");
