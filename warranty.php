...
<html lang="en">
    ...
    <body>
						...
						<ul>
							...
							<li class="submenu-open">
								...
								<ul>
									...
									<li class="active"><a href="warranty.php"><i data-feather="bookmark"></i><span>Warranties</span></a></li>									
					...
					<div id="sidebar-menu-2" class="sidebar-menu sidebar-menu-three">
						...
						<div class="tab-content tab-content-four pt-2">
							...
							<ul class="tab-pane active" id="product" aria-labelledby="messages-tab">
								...
								<li><a href="warranty.php" class="active"><span>Warranties</span></a></li>									
		...
		<div class="sidebar-settings nav-toggle all" id="myDiv"  onclick="toggleClass()">
