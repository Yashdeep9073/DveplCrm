...
<head>
    ...
    <title>Completed Jobs- D.V. Electromatic Pvt. Ltd</title>
                                ...
                                <tbody>
                                    ...
                                    foreach ($result_completed as $data_completed) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                // Decode the job_details JSON
                                                $job_details = json_decode($data_completed['job_details'], true);
                                                if (!empty($job_details) && is_array($job_details)) {
                                                    // Extract all serial_no values and join them (e.g., with commas)
                                                    $serial_nos = array_column($job_details, 'serial_no');
                                                    echo htmlspecialchars(implode(', ', $serial_nos));
                                                } else {
                                                    echo '-'; // Fallback if no serial numbers are found
                                                }
                                                ?>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <?php echo $data_completed['concerned_engineer']; ?>
                                            </td>
                                            <td>
                                                <?php echo $data_completed['costing_engineer']; ?>
                                            </td>
                                            <td>
                                                <?php echo $data_completed['job_name']; ?>
                                            </td>
                                            <!-- <td><?php echo $data_completed['category_name']; ?></td>--->
                                            <td>
                                            ...
                                            <!-- <td>
                                                    <?php echo $data_completed['item_no']; ?>
                                                </td> -->
                                            ...
                                            <!-- <td>
                                                    <?php echo $data_completed['total_amount']; ?>
                                                </td> -->
                                            <td>
                                            ...
                                            <td>
                                                <?php echo $data_completed['po_payment']; ?>
                                            </td>
                                            <td>
                                                <?php echo $data_completed['po_no']; ?>
                                            </td>
                                            <!-- <td>
                                                    <?php echo $data_completed['dispatch']; ?>
                                                </td> -->
                                            ...
                                            <td>
                                                <?php echo $data_completed['remark']; ?>
                                            </td>
                                            <!-- <td><?php echo $data_completed['status']; ?></td> -->
